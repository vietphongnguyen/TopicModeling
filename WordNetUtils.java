...
//		IDictionary dict = WordNetUtils.getDictionary("resources/wordnet3.0");
		IDictionary dict = WordNetUtils.getDictionary("C:\\Program Files (x86)\\WordNet\\2.1\\dict");
		
		String text1, text2;
		//ISynset hypernym = getSynsets(dict, "act", "VERB", false).get(0);
		ISynset hypernym = getSynsets(dict, "buy", "VERB", false).get(0);
		System.out.println(hypernym.getGloss());

		boolean b = isHypernym(dict, "purchase", "VERB", hypernym, false);
		System.out.println("isHypernym? " +b);

		System.out.println(isHypernym(dict, "purchase", "VERB", "buy", false));

		// getRoots(dict);
		// System.out.println(getRoots(dict).size());

		text1 = "mother";
		ISynset synnet1 = getSynsets(dict, text1 , "N", false).get(0);
		System.out.println("getSynsets of '" + text1 + "' is: " + synnet1);
		
		text2 = "person";
		ISynset synnet2 = getSynsets(dict, text2 , "N", false).get(0);
		System.out.println("getSynsets of '" + text2 + "' is: " + synnet2);
		
		System.out.println(text2 + " isHypernym of " + text1 + " ? : " + isHypernym(dict, synnet1, synnet2, false));
