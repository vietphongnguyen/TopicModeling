		    ...
		    if (file.isFile()) {
		        ...
		        if (!fileName.equalsIgnoreCase(fileName2)) {
		    		...
		    		if(file.renameTo(newfile)){
		    			...
		    			Out("Warning: " + fileName + " COUNLD NOT rename to : " + fileName2 + ". This file will be igrored\n");
		    			continue;
		    		}
		        }
				...
				if (language.equalsIgnoreCase("en") || language.equalsIgnoreCase("et")) {
					...
					System.out.println("Warning: the content of the file:" + fileName + " have NOT been writen in English then this file will be ignored!");
					Outln("Warning: the content of the file:" + fileName + " have NOT been writen in English then this file will be ignored!");
				}
		    }
		}
